...
<div class="accueil">
    ...
    <section>
        ...
        <div class="card">
  <img src="<?= $sandwichs['photo']?>" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title"><?= $sandwichs["nom"]?></h5>
    <p class="card-text black"><?= $sandwichs ['description']?></p>
    <p class="black"><?= $sandwichs ['prix']?> €</p>
  </div>
        </div></div>
    </section>
